...
{
    public class CustomPanderPanelWColors : CustomColors
    {
        ...
        #region Properties
        /// <summary>
        /// Gets or sets the backcolor of a PanderPanelW.
        /// </summary>
        [Description("The backcolor of a PanderPanelW.")]
        ...
        /// <summary>
        /// Gets or sets the starting color of the gradient on a flat PanderPanelW captionbar.
        /// </summary>
        [Description("The starting color of the gradient on a flat PanderPanelW captionbar.")]
        ...
        /// <summary>
        /// Gets or sets the end color of the gradient on a flat PanderPanelW captionbar.
        /// </summary>
        [Description("The end color of the gradient on a flat PanderPanelW captionbar.")]
        ...
        /// <summary>
        /// Gets or sets the starting color of the gradient used when the PanderPanelW is pressed down.
        /// </summary>
        [Description("The starting color of the gradient used when the PanderPanelW is pressed down.")]
        ...
        /// <summary>
        /// Gets or sets the end color of the gradient used when the PanderPanelW is pressed down.
        /// </summary>
        [Description("The end color of the gradient used when the PanderPanelW is pressed down.")]
        ...
        /// <summary>
        /// Gets or sets the middle color of the gradient used when the PanderPanelW is pressed down.
        /// </summary>
        [Description("The middle color of the gradient used when the PanderPanelW is pressed down.")]
        ...
        /// <summary>
        /// Gets or sets the starting color of the gradient used when the PanderPanelW is checked.
        /// </summary>
        [Description("The starting color of the gradient used when the PanderPanelW is checked.")]
        ...
        /// <summary>
        /// Gets or sets the end color of the gradient used when the PanderPanelW is checked.
        /// </summary>
        [Description("The end color of the gradient used when the PanderPanelW is checked.")]
        ...
        /// <summary>
        /// Gets or sets the middle color of the gradient used when the PanderPanelW is checked.
        /// </summary>
        [Description("The middle color of the gradient used when the PanderPanelW is checked.")]
        ...
        /// <summary>
        /// Gets or sets the starting color of the gradient used when the PanderPanelW is selected.
        /// </summary>
        [Description("The starting color of the gradient used when the PanderPanelW is selected.")]
        ...
        /// <summary>
        /// Gets or sets the end color of the gradient used when the PanderPanelW is selected.
        /// </summary>
        [Description("The end color of the gradient used when the PanderPanelW is selected.")]
        ...
        /// <summary>
        /// Gets or sets the middle color of the gradient used when the PanderPanelW is selected.
        /// </summary>
        [Description("The middle color of the gradient used when the PanderPanelW is selected.")]
        ...
        /// <summary>
        /// Gets or sets the text color used when the PanderPanelW is selected.
        /// </summary>
        [Description("The text color used when the PanderPanelW is selected.")]
