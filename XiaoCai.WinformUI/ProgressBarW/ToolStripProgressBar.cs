...
namespace XiaoCai.WinformUI.Panels
{
    ...
    public class ToolStripProgressBar : ToolStripControlHost
    {
        ...
        /// </summary>
        /// <value>
        /// Type: <see cref="XiaoCai.WinformUI.Panels.ProgressBarW"/>
        /// A ProgressBar.
        /// </value>
        public ProgressBarW ProgressBar
        {
            get { return base.Control as ProgressBarW; }
        }
        /// <summary>
        ...
        {
            XiaoCai.WinformUI.Panels.ProgressBarW progressBar = new XiaoCai.WinformUI.Panels.ProgressBarW();
