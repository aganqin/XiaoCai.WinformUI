...
namespace XiaoCai.WinformUI.Panels
{
    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// </summary>
        public BseRenderer()
            : base(new XiaoCai.WinformUI.Panels.ColorTableBlack())
        {
        ...
        /// </summary>
        /// <param name="professionalColorTable">A <see cref="XiaoCai.WinformUI.Panels.ProfessionalColorTable"/> to be used for painting.</param>
